  ...
  return (
    <div className='shadow-md w-full fixed top-0 left-0'>
      <div className=' text-[#3794fc] md:flex items-center justify-between bg-white py-4 md:px-10 px-7'>
        <h1 className='z-10 cursor-pointer pt-2 md:pt-1 ml-3 md:text-2xl'><span className='md:text-4xl text-2xl'>J</span>ody <span className='md:text-4xl text-2xl'>V</span>an<span className='md:text-4xl text-2xl'>H</span>oose</h1>
